    ...
    $(document).ready(function() {
        ...
        */
        function render(items) {
            return items
                ...
                .map(
                    ...
                    item.name +
                    "</p>" +
                    '<p class="price">'+ item.price + 'ugr' +'</p>' +
                    '<p class="art">' +
                    item.atr +
                    "</p>" +
                    '<div class="d-flex">' +
        ...
        function init_cart() { // инициализация корзины
            ...
            // $("body").append('<div class=cart_wrap><div class=modal-dialog role=document><div class=modal-content><div class=qa-shoping-cart-list data-qaid=shopping_cart_list><h4 class=x-title>Корзина заказов</h4><div class=cart_items></div><div class="qa-shopping-company-cart x-shc-group"data-qaid=shopping_company_cart><div class=x-shc-total><div class=x-shc-total__info-wrapper><div class=x-shc-total__label>Всего:</div><div class=x-shc-total__price data-qaid=total_sum_order></div></div><div class=x-shc-total__controls-wrapper><div class=x-shc-total__continue-control-holder><span class="x-button x-shc-total__button x-button_theme_purple x-button_type_contour x-shc-total__button_type_continue"><span class=x-button__text data-qaid=continue_shopping>Продолжить покупки</span></span></div><div class=x-shc-total__main-control-holder><span class="x-shc-total__button btn qa-sc_list-buy_button"data-qaid=create_order_btn><span class=x-button__text >Сделать заказ</span><span class="x-button__text send">Отправить заказ</span></span></div></div></div></div></div><span class=modal-close>x</span></div></div><div class=modal-backdrop></div></div>'); // добавлние UI обертки корзины в DOM
            cart_item_tpl = ('<tr class="x-shc-item" data-qaid="product_item"><td><div class="current"><input type="number" value="1"><div class="current__btn"><span class="plus"></span><span class="minus"></span></div></div></td><td class="x-shc-item__image-cell"><img class="x-shc-item__image" src=""></td><td><div class="x-shc-item__title-holder">sneakers </div></td> <td><div class="x-shc-item__price-holder">Код/Артикул: <span class="x-shc-item__price articul"></span></div></td><td><div class="x-shc-item__price-holder">Модель: <span class="x-shc-item__price model"></span></div></td><td><div class="x-shc-item__summary-cell"><div class="x-shc-item__cell-label">Сумма</div><div><div class="x-shc-item__summary-price" data-qaid="product_price"></div></div></div></td><td class="x-shc-item__control-cell"><div><span class="x-shc-item__control delete_product_icon" data-qaid="delete_product_icon"><svg viewPort="0 0 12 12" version="1.1" xmlns="http://www.w3.org/2000/svg"><line x1="1" y1="11" x2="11" y2="1" stroke="black" stroke-width="2" /><line x1="1" y1="1" x2="11" y2="11" stroke="black" stroke-width="2" /></svg></span></div></td></tr>'); // шаблон позиции в корзине 
        ...
        function show_cart() { // отображение корзины
            ...
            for (var product in cart_products) {
                ...
                var psum = price;
                if (dop.length > 0) {
                    psum = psum + cart_products[product]['priced'] * current;
                }
        ...
        //     }
        //     if (cpid == 1) {
        //         $('.x-shc-total__button_type_continue span').html(prod2);
        //     }
        //     if (cpid > 1) {
        //         $('.x-shc-total__button_type_continue span').html(prod3);
        //     }
